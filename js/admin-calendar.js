...
async function fetchCalendarBookings() {
    ...
    console.log('✅ Calendar bookings loaded:', calendarBookings.length);
    if (calendarBookings.length > 0) {
        console.log('✅ Sample normalized booking:', calendarBookings[0]);
    }
}
...
function renderMonthView() {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
        ...
        if (dayBookings.length > 0) {
            console.log(`📌 Day ${day} has ${dayBookings.length} bookings:`, dayBookings);
        }
