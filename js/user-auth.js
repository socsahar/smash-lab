...
(function() {
    ...
    function updateLoginLink() {
        ...
        console.log('Checking login state:', { currentUser, isAdmin });
        ...
        if (currentUser || isAdmin) {
            ...
            console.log('Login link changed to logout for user:', userName);
        } else {
            ...
            console.log('Login link set to login state');
        }
    }
    ...
    function isAdminLoggedIn() {
        ...
        console.log('Is admin logged in:', isAdmin, { isAdminSession, isAdminLocal, isAdminUser });
        return isAdmin;
    }
