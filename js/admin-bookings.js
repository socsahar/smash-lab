...
function getPackageDisplayName(packageId) {
    ...
    const packageNames = {
        ...
        'solo-rage-expanded': 'חדר זעם - מורחב',
        'solo-rage-extreme': 'חדר זעם - מוגזם',
        'solo-rage-explode': 'חדר זעם - בא לי להתפוצץ',
        'solo-axes-taste': 'הטלת גרזנים - טעימה של הטלה',
        'solo-axes-full': 'הטלת גרזנים - אם כבר אז כבר',
        'solo-axes-pro': 'הטלת גרזנים - יוצא מקצוען',
        'solo-paint-basic': 'חדר צבע - בסיסי',
        'solo-paint-expanded': 'חדר צבע - מורחב',
        'solo-paint-extreme': 'חדר צבע - מוגזם',
        'solo-combo-basic': 'משולב - בסיסי',
        'solo-combo-expanded': 'משולב - מורחב',
        'solo-combo-extreme': 'משולב - מוגזם',
        // Couple packages
        'couple-rage-basic': 'חדר זעם - בסיסי (זוגות)',
        'couple-rage-expanded': 'חדר זעם - מורחב (זוגות)',
        'couple-rage-extreme': 'חדר זעם - מוגזם (זוגות)',
        'couple-rage-explode': 'חדר זעם - בא לנו להתפוצץ (זוגות)',
        'couple-axes-taste': 'הטלת גרזנים - טעימה של הטלה (זוגות)',
        'couple-axes-full': 'הטלת גרזנים - אם כבר אז כבר (זוגות)',
        'couple-axes-pro': 'הטלת גרזנים - יוצאים מקצוענים (זוגות)',
        'couple-paint-basic': 'חדר צבע - בסיסי (זוגות)',
        'couple-paint-expanded': 'חדר צבע - מורחב (זוגות)',
        'couple-paint-extreme': 'חדר צבע - מוגזם (זוגות)',
        'couple-combo-basic': 'משולב - בסיסי (זוגות)',
        'couple-combo-expanded': 'משולב - מורחב (זוגות)',
        'couple-combo-extreme': 'משולב - מוגזם (זוגות)',
        // Family packages
        'family-rage-basic': 'חדר זעם - בסיסי (משפחות)',
        'family-rage-expanded': 'חדר זעם - מורחב (משפחות)',
        'family-rage-extreme': 'חדר זעם - מוגזם (משפחות)',
        'family-rage-explode': 'חדר זעם - בא לנו להתפוצץ (משפחות)',
        'family-axes-taste': 'הטלת גרזנים - טעימה של הטלה (משפחות)',
        'family-axes-full': 'הטלת גרזנים - אם כבר אז כבר (משפחות)',
        'family-axes-pro': 'הטלת גרזנים - יוצאים מקצוענים (משפחות)',
        'family-paint-basic': 'חדר צבע - בסיסי (משפחות)',
        'family-paint-expanded': 'חדר צבע - מורחב (משפחות)',
        'family-paint-extreme': 'חדר צבע - מוגזם (משפחות)',
        'family-combo-basic': 'משולב - בסיסי (משפחות)',
        'family-combo-expanded': 'משולב - מורחב (משפחות)',
        'family-combo-extreme': 'משולב - מוגזם (משפחות)',
        // Banda packages
        'banda-rage-basic': 'חדר זעם - בסיסי (בנדות)',
        'banda-rage-expanded': 'חדר זעם - מורחב (בנדות)',
        'banda-rage-extreme': 'חדר זעם - מוגזם (בנדות)',
        'banda-rage-explode': 'חדר זעם - בא לנו להתפוצץ (בנדות)',
        'banda-axes-taste': 'הטלת גרזנים - טעימה של הטלה (בנדות)',
        'banda-axes-full': 'הטלת גרזנים - אם כבר אז כבר (בנדות)',
        'banda-axes-pro': 'הטלת גרזנים - יוצאים מקצוענים (בנדות)',
        'banda-paint-basic': 'חדר צבע - בסיסי (בנדות)',
        'banda-paint-expanded': 'חדר צבע - מורחב (בנדות)',
        'banda-paint-extreme': 'חדר צבע - מוגזם (בנדות)',
        'banda-combo-basic': 'משולב - בסיסי (בנדות)',
        'banda-combo-expanded': 'משולב - מורחב (בנדות)',
        'banda-combo-extreme': 'משולב - מוגזם (בנדות)',
        // General room types
        'paint-room': 'חדר צבע',
        'rage-room': 'חדר זעם',
