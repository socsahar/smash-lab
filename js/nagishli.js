...
function initNagishLi() {
    ...
    function W(a) {
        ...
        a = a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,
            function(a, d, e, f) { return d + d + e + e + f + f });
    ...
    function f(a, d, e) {
        e = void 0 === e ? !1 : e;
        if (!A) return !1;
        var f = { version: M, menu: "closed", position: N, submenus: "000000", help: "0", text: "0", colors: "normal", display: "normal", highlight: "00", zoom: "0.0", font: "normal", animations: "on", cursor: "normal", tabbing: "off", r2m: "off", ok: "0" };
    ...
    if ("undefined" != typeof nl_lic) try { x = nl_lic, window.atob(x) } catch (a) { x = "0" }
    if ("0" != x) { O = window.atob(x).split("+", 2)[0]; var oa = window.atob(x).split("+", 2)[1] }
    ...
    if (!K && m) {
        var p = !1,
            v = !1,
            u = !1,
            z = !1; - 1 != m.indexOf("|") ? (m = nl_contact.split("|"), m.forEach(function(a) {!1 !== !!~a.indexOf("n:") && (p = a.replace("n:", ""));!1 !== !!~a.indexOf("p:") && (v = a.replace("p:", ""));!1 !== !!~a.indexOf("u:") && (u = !1 !== !!~a.indexOf("d:") ? a.replace("+", "@").replace("u:", "").replace("d:", "") : a.replace("u:", "") + "@" + D);!1 !== !!~a.indexOf("f:") && (z = a.replace("f:", "")) })) : -1 != m.indexOf("n:") ? p = m.replace("n:", "") : -1 != m.indexOf("p:") ? v = m.replace("p:", "") : -1 != m.indexOf("u:") ? u = -1 != m.indexOf("d:") ? m.replace("+", "@").replace("u:", "").replace("d:", "") : m.replace("u:", "") + "@" + D : -1 != m.indexOf("f:") && (z = m.replace("f:", ""))
    }
    phrases = "en" == g ? {
    ...
    $NagishLi(function(a) {
        function m(b, c) {
            ...
            if (a("body").attr("nl-colors") != c) {
                if ("custom" == a("body").attr("nl-colors") && (a("*").not(commons.not).each(function() { for (var b = a(this).length; b--;) a(this)[b].style.setProperty("background-color", "", ""), a(this)[b].style.setProperty("color", "", ""), a(this)[b].style.setProperty("border-color", "", "") }), a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLCustomColorsBG > #NLCurrentBG, " +
        ...
        function u(b, c) {
            ...
            if (a("body").attr("nl-colors") != b) {
                ...
                a(":root").css({ filter: d, "-webkit-filter": d, "-khtml-filter": d, "-ms-filter": d, "-o-filter": d, "-moz-filter": d });
        ...
        function p(b, c) {
            ...
            if (a("body").attr("nl-colors") != c) {
                if ("custom" == a("body").attr("nl-colors") && (a("*").not(commons.not).each(function() { for (var b = a(this).length; b--;) a(this)[b].style.setProperty("background-color", "", ""), a(this)[b].style.setProperty("color", "", ""), a(this)[b].style.setProperty("border-color", "", "") }), a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLCustomColorsBG > #NLCurrentBG, " + commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLCustomColorsTXT > #NLCurrentTXT").css({
        ...
        function z(b) {
            ...
            "custom" == a("body").attr("nl-colors") ? (a("*").not(commons.not).each(function() {
                ...
                }), a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLCustomColorsBG > #NLCurrentBG, " + commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLCustomColorsTXT > #NLCurrentTXT").css({ "background-color": "transparent", display: "none" }).removeAttr("aria-label"), a(commons.dd + " > #NagishLiColors > li > #NLCustomColors").children("span.sign").remove(),
                a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLcolorPanel > li.selected").removeClass("selected"), a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.bg + "'] > li[aria-label='" + phrases.clr_custom + "'] > input#NLColorPicker").attr("value", h(a("body").css("background-color"))), a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.txt + "'] > li[aria-label='" + phrases.clr_custom + "'] > input#NLColorPicker").attr("value",
                    ...
                    phrases.aria_select_txtcolor).css("color", a("body").css("color"))) : (a("html").css("height", ""), a(":root").css({ filter: "", "-webkit-filter": "", "-moz-filter": "", "-khtml-filter": "", "-ms-filter": "", "-o-filter": "" }), a("nagishli > style#NagishLiPseudoStyling").remove());
        ...
        function R(b) {
            ...
            var c = b;
            a("*").not(commons.not).each(function() { for (var b = a(this).length; b--;) a(this)[b].style.setProperty("font-size", c + "px", "important") });
        ...
        function I(b) {
            b = void 0 ===
                b ? "0" : b;
            a("body[nl-text]").length && (a("body").removeAttr("nl-text"), a("*").not(commons.not).each(function() { for (var b = a(this).length; b--;) a(this)[b].style.setProperty("font-size", "", ""), "0px" == a(this).css("font-size") && a(this)[b].style.setProperty("font-size", "initial", "") }), a(commons.dd + " > .nl-dropdown-toggle > #NLTextVal")[0].innerHTML = "", f("change", "text", b))
        }
        ...
        function Y(b) {
            ...
            if ("text" != a("body").attr("nl-display")) {
                ...
                ""), c = "normal";
            if (b) return a("" + commons.dd + " > #NagishLiDisplay > li > #NLTextDisplay").attr("aria-label", phrases.aria_the_option + phrases.text_only + " " + phrases.r2m_on).prepend(commons.checkmark).parent("li").addClass("active").siblings("li").removeClass("active").find("span.sign").remove(), a("" + commons.dd + " > #NagishLiDisplay").prev("div.nl-dropdown-toggle").hasClass("open") || a('<span class="selected">' + phrases.text_only + "</span>").insertAfter(a("" + commons.dd + " > #NagishLiDisplay").prev("div", ".nl-dropdown-toggle").children(".nl-dropdown-title")), !1;
            f("change", "display", c)
        }
        ...
        function T(b) {
            b ?
                ...
                }), a("body[nl-hl-headings]").length && a("h1 a, h2 a, h3 a, h4 a, h5 a, h6 a, h1 span, h2 span, h3 span, h4 span, h5 span, h6 span").each(function() { this.style.setProperty("color", "inherit", "important") }), a("body").removeAttr("nl-hl-links"), b = "0") : (a("* a").not("#NagishLiBar a").each(function() {
                    this.style.setProperty("outline", "3px red dotted", "important");
                    this.style.setProperty("background-color", "black", "important");
                    this.style.setProperty("color", "yellow", "important")
        ...
        function U(b) {
            b ? (a(commons.dd + " > #NagishLiHighlight > li > #NLHighlightHeadings").attr("aria-label", phrases.aria_the_option + phrases.hl_headings + " " + phrases.r2m_on).prepend(commons.checkmark).parent("li").addClass("active"), a("h1, h2, h3, h4, h5, h6").each(function() {
                ...
                this.style.setProperty("background",
                    "black", "important");
                this.style.setProperty("color", "yellow", "important")
            }), a("body[nl-hl-links]").length || a("h1 a, h2 a, h3 a, h4 a, h5 a, h6 a, h1 span, h2 span, h3 span, h4 span, h5 span, h6 span").each(function() { this.style.setProperty("color", "inherit", "important") }), a("body").attr("nl-hl-headings", "1")) : (a("body[nl-hl-headings]").length ? (a("h1, h2, h3, h4, h5, h6").each(function() {
                this.style.setProperty("outline", "", "");
                this.style.setProperty("background", "", "");
                this.style.setProperty("color",
                    "", "")
        ...
        function ea(b) {
            b =
                void 0 === b ? "0.0" : b;
            a("body, body > iframe").css({ zoom: "", "-webkit-transform-origin": "", "-moz-transform-origin": "", "-khtml-transform-origin": "", "-ms-transform-origin": "", "-o-transform-origin": "", "-webkit-transform": "", "-moz-transform": "", "-khtml-transform": "", "-ms-transform": "", "-o-transform": "" });
        ...
        function ja() { a(commons.dd + " > .nl-dropdown-toggle.open").length ? a(commons.bar + " > #NagishLiBarStrip > #NagishLiToggleMenus").attr({ "class": "collapse-all", "aria-label": phrases.collapse_all }) : a(commons.bar + " > #NagishLiBarStrip > #NagishLiToggleMenus").attr({ "class": "expand-all", "aria-label": phrases.expand_all }) }
        ...
        function Z() {
            a("[nl-role*='media']").length && (a("iframe[src*='youtube.com']").each(function() { for (var b = a(this).length; b--;) "ytmedia" == a(this).attr("nl-role") ? (a("iframe[src*='youtube.com']")[b].contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"), a(this).attr("nl-role", "ytmedia-paused")) : a(this).attr("nl-role", "ytmedia") }), a("video, audio").each(function() {
                for (var b =
        ...
        if (A) {
            var w = function(a) {
                ...
                J = w(f("read", "version"));
            w = w(M);
            if (J.major < w.major || J.minor < w.minor || J.patch < w.patch) return f("delete"), a(commons.bar).css({ "max-height": "", "overflow-y": "" }), a(commons.bar + " > #NagishLiBarStrip > #NagishLiToggleMenus, " + commons.bar + " > #NagishLiBarStrip > #NagishLiMove").remove(), a(commons.bar + " > #NagishLiBarStrip").addClass("open"), a(commons.menus).show(), a(commons.menus).html('<li class="nl-dropdown"><ul class="nl-dropdown-menu show"><li class="not-clickable"><div href="#">' +
                phrases.settings_upgrade_html + "</div></li></ul></li>"), !1
        }! function(a, c) { "object" == typeof exports && "undefined" != typeof module ? module.exports = c() : "function" == typeof define && define.amd ? define(c) : (a = a || self).hotkeys = c() }(this, function() {
            function a(a, b, c) { a.addEventListener ? a.addEventListener(b, c, !1) : a.attachEvent && a.attachEvent("on".concat(b), function() { c(window.event) }) }

            function c(a, b) { for (var c = b.slice(0, b.length - 1), d = 0; d < c.length; d++) c[d] = a[c[d].toLowerCase()]; return c }
            ...
            function e(a) { z = a || "all" }

            function f() { return z || "all" }
            ...
            function h(a) {
                ...
                if (m.filter.call(this, a)) {
                    if (~p.indexOf(c) || 229 === c || p.push(c), 93 !== c && 224 !== c || (c = 91), c in t) { for (var d in t[c] = !0, q) q[d] === c && (m[d] = !0); if (!b) return }
            ...
            function m(b, e, f) {
                ...
                for ("string" == typeof e && (F = e); k < l.length; k++) g = [], 1 < (b = l[k].split("+")).length && (g = c(q, b)), (b = "*" === (b = b[b.length - 1]) ? "*" : y(b)) in r || (r[b] = []), r[b].push({ keyup: n, keydown: E, scope: F, mods: g, shortcut: l[k], method: f, key: l[k] });
                void 0 === B || -1 < w.indexOf(B) || !window || (w.push(B), a(B, "keydown", function(a) { h(a) }), a(window, "focus", function() { p = [] }), a(B, "keyup", function(a) {
                    h(a);
            ...
            for (var k = "undefined" != typeof navigator && 0 < navigator.userAgent.toLowerCase().indexOf("firefox"), u = { backspace: 8, tab: 9, clear: 12, enter: 13, "return": 13, esc: 27, escape: 27, space: 32, left: 37, up: 38, right: 39, down: 40, del: 46, "delete": 46, ins: 45, insert: 45, home: 36, end: 35, pageup: 33, pagedown: 34, capslock: 20, "\u21ea": 20, ",": 188, ".": 190, "/": 191, "`": 192, "-": k ? 173 : 189, "=": k ? 61 : 187, ";": k ? 59 : 186, "'": 222, "[": 219, "]": 221, "\\": 220 }, q = {
                    ...
                    cmd: k ? 224 : 91,
                    command: k ? 224 : 91
                }, v = { 16: "shiftKey", 18: "altKey", 17: "ctrlKey" }, t = { 16: !1, 18: !1, 17: !1 }, r = {}, n = 1; 20 > n; n++) u["f".concat(n)] = 111 + n;
            t[k ? 224 : 91] = !(v[k ? 224 : 91] = "metaKey");
            var p = [],
                z = "all",
                w = [],
                y = function(a) { return u[a.toLowerCase()] || q[a.toLowerCase()] || a.toUpperCase().charCodeAt(0) };
            k = {
                setScope: e,
                getScope: f,
        ...
        a(commons.dd + " > #NagishLiColors > li > #NLGrayscaleColors").click(function() { m() });
        a(commons.dd + " > #NagishLiColors > li > #NLInvertColors").click(function() { k() });
        a(commons.dd + " > #NagishLiColors > li > #NLWarmColors").click(function() { u("warm") });
        a(commons.dd + " > #NagishLiColors > li > #NLColdColors").click(function() { u("cold") });
        a(commons.dd + " > #NagishLiColors > li > #NLSaturateColors").click(function() { p() });
        a(commons.dd + " > #NagishLiColors > li > #NLNormalColors").click(function() { z() });
        a(commons.dd + " > #NagishLiText > li > #NLBiggerText").click(function() { R() });
        a(commons.dd + " > #NagishLiText > li > #NLSmallerText").click(function() { S() });
        a(commons.dd + " > #NagishLiText > li > #NLNormalText").click(function() { I() });
        a(commons.dd + " > #NagishLiDisplay > li > #NLTextDisplay").click(function() { Y() });
        a(commons.dd + " > #NagishLiDisplay > li > #NLImagesDisplay").click(function() { aa() });
        a(commons.dd + " > #NagishLiDisplay > li > #NLNormalDisplay").click(function() { ba() });
        a(commons.dd + " > #NagishLiHighlight > li > #NLHighlightLinks").click(function() { T() });
        a(commons.dd + " > #NagishLiHighlight > li > #NLHighlightHeadings").click(function() { U() });
        a(commons.dd + " > #NagishLiMisc > li > #NLZoom > #NLZoomIn").click(function() { ca() });
        a(commons.dd + " > #NagishLiMisc > li > #NLZoom > #NLZoomOut").click(function() { da() });
        a(commons.dd + " > #NagishLiMisc > li > #NLZoom > #NLNormalZoom").click(function() { ea() });
        a(commons.dd + " > #NagishLiMisc > li > #NLFont").click(function() { fa() });
        a(commons.bar + " > #NagishLiBarStrip > #NagishLiMove > #NagishLiMoveTL").click(function() { y("TL") });
        a(commons.bar + " > #NagishLiBarStrip > #NagishLiMove > #NagishLiMoveBR").click(function() { y("BR") });
        a(commons.bar + " > #NagishLiBarStrip > #NagishLiMove > #NagishLiMoveBL").click(function() { y("BL") });
        a(commons.bar + " > #NagishLiBarStrip > #NagishLiMove > #NagishLiMoveTR").click(function() { y("TR") });
        if (A) {
            var la = function(b) {
                ...
                if (!a("#NagishLiOverlayContent").length) {
                    if (a(commons.menus).is(":visible")) {
                        a(commons.menus).slideUp(150,
                            function() { a(commons.bar + " > #NagishLiBarStrip").removeClass("open") });
                        var d = "closed"
        ...
        a(commons.dd + " > #NagishLiMisc > li > #NLR2M").click(function() { ia() });
        a(commons.dd + " > #NagishLiMisc > li > #NLCursor > #NLCursorBlack").click(function() { L("black") });
        a(commons.dd + " > #NagishLiMisc > li > #NLCursor > #NLCursorWhite").click(function() { L("white") });
        a(commons.dd + " > #NagishLiMisc > li > #NLKBNav").click(function() { ka() });
        H || a(commons.dd + " > .nl-dropdown-toggle").each(function() { a(this).append('<span class="nl-dropdown-arrow" aria-hidden="true" aria-label="' + phrases.aria_toggle_open_alt + a(this).children(".nl-dropdown-title").text() + '" style="background: ' + icons.toggle_single + ';"></span>') });
        A ? function() {
            var b = f("read", "ok"),
                c = f("read", "colors"),
                d = f("read", "position"),
            ...
            if ("0" == b && ("0" != e && (8 >= parseInt(e) || 35 <= parseInt(e)) || "0.0" != h && (.5 >= parseFloat(h) || 2.5 <= parseFloat(h)) || -1 !== c.indexOf(",") && c.split(",")[0] == c.split(",")[1])) {
                ...
                if (1 == b) return f("delete"), a(commons.bar).css({ "max-height": "", "overflow-y": "" }), a(commons.bar + " > #NagishLiBarStrip > #NagishLiToggleMenus, " + commons.bar + " > #NagishLiBarStrip > #NagishLiMove").remove(), a(commons.bar +
        ...
        a("body").on("mousedown keypress.nlkbnavclk", function(b) {
            !a(commons.menus).is(":visible") || a(b.target).is("#NagishLiBar, .NagishLiOverlay, a, span[nl-r2m-data], #NLCustomColorsTXT, #NLCustomColorsBG, #NLCloseColorPanel") ||
                a(b.target).parents("#NagishLiBar, .NagishLiOverlay, a, span[nl-r2m-data]").length || (a(commons.menus).slideUp(150, function() { a(commons.bar + " > #NagishLiBarStrip").removeClass("open") }), f("change", "menu", "closed"))
        });
        ...
        a(commons.dd + " > .nl-dropdown-toggle").click(function(b, c) {
            ...
            H ? (a(commons.dd + " > .nl-dropdown-toggle").not(a(this)).removeClass("open").next("ul.nl-dropdown-menu").slideUp("fast").removeClass("show"), a(this).toggleClass("open").next("ul.nl-dropdown-menu").slideToggle("fast").toggleClass("show"),
                ...
                phrases.aria_toggle_open_alt + a(this).children(".nl-dropdown-title").text()), a(this).children(".nagishli-sr-only").text(phrases.aria_toggle_open_alt + a(this).children(".nl-dropdown-title").text())), f("change", "submenus", { to: b, pos: c }));
            ja()
        });
        a(commons.bar + " > #NagishLiBarStrip > #NagishLiToggleMenus").on("click keypress.nlkbnavclk", function(b, c) {
            !a(b.target).parent("span#NagishLiToggleMenus") || 1 !== b.which && 13 !== b.which || (a(this).hasClass("expand-all") ? (a(this).attr({ "class": "collapse-all", "aria-label": phrases.collapse_all }),
        ...
        a(commons.dd + " > #NagishLiInfo > li > #NagishLiStatement, " +
            ...
            if ("NagishLiStatement" == b.target.id && K) window.location.replace(K);
                ...
                var d = c.first(),
                    e = c.last();
                d.focus();
                e.on("keydown", function(a) { 9 !== a.which || a.shiftKey || (a.preventDefault(), d.focus()) });
                d.on("keydown", function(a) { 9 === a.which && a.shiftKey && (a.preventDefault(), e.focus()) })
            }
        });
        a(commons.dd + " > ul > li > div > span.help, " + commons.dd + " > ul > li > div > span.notice").attr("data-balloon-pos", phrases.align_left).on("mousedown keypress.nlkbnavclk", function() { alert(a(this).data("balloon")); return !1 });
            ...
            a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > ul > li#NLCloseColorPanel").on("click keypress.nlkbnavclk",
                function() {
                    ...
                    a(this).parent("ul#NLcolorPanel").data("type") === phrases.bg ? (b.length ? a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLCustomColorsBG > #NLCurrentBG").css({
                        ...
                        display: "inline-block"
                    }).attr("aria-label", b.attr("aria-label")) : a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLCustomColorsBG > #NLCurrentBG").css({ "background-color": "", display: "none" }), a("body[nl-kbnav]").length && document.getElementById("NLCustomColorsBG").focus()) : (c.length ? a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLCustomColorsTXT > #NLCurrentTXT").css({ "background-color": c.css("background-color"), display: "inline-block" }).attr("aria-label", c.attr("aria-label")) :
                        a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLCustomColorsTXT > #NLCurrentTXT").css({ "background-color": "", display: "none" }), a("body[nl-kbnav]").length && document.getElementById("NLCustomColorsTXT").focus());
        ...
        a(commons.dd + " > #NagishLiText > li").click(function() { a(this).is(":last-child") && !a(this).find("span.sign").length && a(commons.checkmark).prependTo(a(this).children("div")) }).on("mousedown keypress", function(b) {
        ...
        }).on("mouseup mouseleave mouseout keydown keyup", function() { a(this).is(":last-child") || a(this).find("span.sign").remove() });
        ...
        a(commons.dd + " > #NagishLiHighlight > li").click(function() { a(this).hasClass("active") ? a(this).removeClass("active").find("span.sign").remove() : a(commons.checkmark).prependTo(a(this).addClass("active").children("div")) });
        ...
        a("span#NagishLiMove > span").hover(function(b) { a(this).css("background-color", "mouseenter" === b.type ? "white" : "transparent") });
        a(commons.dd + " > .nl-dropdown-menu > li > div[tabindex='13']").click(function() { alert(a(this).data("balloon")) });
